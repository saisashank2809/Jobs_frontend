    ...
    return (
        <div className="max-w-[1600px] mx-auto pt-8 pb-12 px-6 md:px-10 min-h-screen">
            <header className="mb-6 flex flex-col md:flex-row md:items-end justify-between gap-8">
                <div>
                    <div>
                        <h1 className="text-2xl font-bold text-black tracking-tight leading-none">Identity</h1>
                            ...
                            <div>
                                ...
                                {editMode ? (
                                    <input
                                        ...
                                        className="w-full bg-zinc-50 border-none rounded-lg px-4 py-2.5 font-bold text-sm focus:bg-white focus:ring-4 focus:ring-black/5 transition-all outline-none"
                                ...
                                <div>
                                    ...
                                    {editMode ? (
                                        <input
                                            ...
                                            className="w-full bg-zinc-50 border-none rounded-lg px-4 py-2.5 font-bold text-sm text-zinc-900 focus:bg-white focus:ring-4 focus:ring-black/5 transition-all outline-none"
                                        />
                                    ) : (
                                        <p className="font-bold flex items-center gap-3 text-zinc-600 text-sm">
                        ...
                        <header className="flex items-center justify-between mb-6">
                            ...
                            <label className="cursor-pointer">
                                <input
                                    ...
                                    disabled={extracting}
                                />
                                <div className={`flex items-center gap-3 px-4 py-2 bg-zinc-50 border-none rounded-full text-[10px] font-black uppercase tracking-widest text-zinc-500 hover:bg-black hover:text-white transition-all shadow-sm ${extracting ? 'bg-black text-white' : ''}`}>
